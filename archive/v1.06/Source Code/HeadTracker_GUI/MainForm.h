...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
			...
			this->dd_comport->Items->AddRange(gcnew cli::array< System::Object^  >(30) {
			...
			this->dd_bluetooth->Location = System::Drawing::Point(547, 424);
			this->dd_bluetooth->Name = L"dd_bluetooth";
			this->dd_bluetooth->Size = System::Drawing::Size(166, 21);
			this->dd_bluetooth->TabIndex = 143;
			// 
			// label5
			// 
			...
			this->rollCenter->Size = System::Drawing::Size(256, 197);
			...
			this->label6->Location = System::Drawing::Point(454, 427);
			...
			this->Controls->Add(this->dd_bluetooth);
