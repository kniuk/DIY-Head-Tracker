...
#define APP_BASIC_WIDTH         540
#define APP_ADVANCED_WIDTH      816

#define APP_BASIC_HEIGHT        700
#define APP_ADVANCED_HEIGHT     700
...
System::Void Form1::Form1_Load(System::Object^  sender, System::EventArgs^  e)
{
    ...
    // Show basic settings
    this->Size = System::Drawing::Size(APP_BASIC_WIDTH, APP_BASIC_HEIGHT);
    basicSettingsToolStripMenuItem->Enabled = false; 
    advancedSettingsToolStripMenuItem->Enabled = true; 
...
System::Void Form1::btn_connect_Click(System::Object^ sender, System::EventArgs^ e)
{
    ...
    TrackerWrap::Tracker->Open(dd_comport->Text);
        ...
        while(TrackerWrap::Tracker->Port->BytesToRead > 0)
        {
            ...
            if (TrackerWrap::Tracker->TrackStreaming)
            {
                if (serialbyte == 13)
                {
                    ...
                    chart1->Series["Series1"]->Points->AddXY(i, SerialData[0] / 100 - 90);
                    chart1->Series["Series3"]->Points->AddXY(i, SerialData[1] / 100 - 90);
                    chart1->Series["Series4"]->Points->AddXY(i, SerialData[2] / 100 - 180);
...
{
    Form1::OnCalWizard_Menu(sender, e);
}
...
System::Void Form1::advancedSettingsToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
    this->Size = System::Drawing::Size(APP_ADVANCED_WIDTH, APP_ADVANCED_HEIGHT);
    basicSettingsToolStripMenuItem->Enabled = true; 
    advancedSettingsToolStripMenuItem->Enabled = false; 
}

System::Void Form1::basicSettingsToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
{
    this->Size = System::Drawing::Size(APP_BASIC_WIDTH, APP_BASIC_HEIGHT);
    basicSettingsToolStripMenuItem->Enabled = false; 
    advancedSettingsToolStripMenuItem->Enabled = true; 
    ...
    if ( openFileDialog->ShowDialog() == System::Windows::Forms::DialogResult::OK )
    {
        try 
        {
            ...
            while ((str = din->ReadLine()) != nullptr) 
            {
                ...
                case 0: fw = Convert::ToSingle(items[0]); break;
